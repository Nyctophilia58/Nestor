          ...
          <div className="glass-light rounded-2xl p-5 shadow-2xl">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-lg glass text-white placeholder-white/40 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400/50"
              />
              <button
                onClick={handleSearch}
                className="px-6 py-3 bg-emerald-500/90 text-white text-sm font-medium rounded-lg hover:bg-emerald-500 transition backdrop-blur"
              >
                Search
              </button>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 mb-16">
        <div className="glass-light rounded-2xl p-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button
            ...
            className="px-8 py-3 bg-emerald-500/80 backdrop-blur text-white font-medium rounded-xl hover:bg-emerald-500 transition whitespace-nowrap"
          >
            Post Property
          </button>
        </div>
